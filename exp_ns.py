...
parser.add_argument('--save_name', type=str, default='ns_2d_SAOT')
parser.add_argument('--data_path', type=str, default='./NS')
...
def main():
    ...
    pos_train = pos_train.reshape(ntrain, h, h, -1)
    pos_test = pos_test.reshape(ntest, h, h, -1)
    train_a = train_a.reshape(ntrain, h, h, -1)
    test_a = test_a.reshape(ntest, h, h, -1)
    train_u = train_u.reshape(ntrain, h, h, -1)
    test_u = test_u.reshape(ntest, h, h, -1)
