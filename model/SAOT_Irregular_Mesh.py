...
from model.Spectral_Attention import Spectral_Attention_Irregular_Mesh
...
class SAOT_Transformer_block(nn.Module):
    ...
    def __init__(
        ...
        self.Attn = Spectral_Attention_Irregular_Mesh(hidden_dim, num_heads, sr_ratio=1, is_filter=is_filter)
